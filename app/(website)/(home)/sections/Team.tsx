  ...
  return (
    <section>
      <div className="py-10 wrapper">
        <h3 className="text-xl font-inter font-semibold text-center">
          {config.subTitle}
        </h3>
        ...
        <div className="flex flex-col gap-5 mt-10">
          <div>
            <Swiper
              ...
              navigation={{
                ...
                nextEl: ".custom-swiper-button-next-home-team",
                prevEl: ".custom-swiper-button-prev-home-team",
                enabled: true,
              }}
              pagination={{
                el: "#container-for-bullets-home-team",
                type: "bullets",
          ...
          <div className="w-max mx-auto flex gap-5">
            <div className="custom-swiper-button-prev-home-team cursor-pointer">
              <SlArrowLeftCircle className="text-5xl" />
            </div>
            <div
              id="container-for-bullets-home-team"
              className="flex items-center gap-3"
            />
            <div className="custom-swiper-button-next-home-team cursor-pointer">
